...
- (void)imageCropController:(GKImageCropViewController *)imageCropController didFinishWithCroppedImage:(UIImage *)croppedImage
{
    ...
    NSLog(@"Image description: %@", [croppedImage description]);
    NSLog(@"Image size: width %f by height %f", croppedImage.size.width, croppedImage.size.height);
