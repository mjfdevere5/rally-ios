...
// Max note: This doesn't seem to get called at all
- (void)drawRect:(CGRect)rect
{
    ...
    CGContextAddRect(ctx, CGRectMake(kHandleDiameter / 2,
                                     kHandleDiameter / 2,
                                     rect.size.width - kHandleDiameter,
                                     rect.size.height - kHandleDiameter));
