...
- (void)viewDidLoad
{
    ...
    COMMON_LOG_WITH_COMMENT(@"Did [super viewDidLoad]")
    
    [[NSBundle mainBundle] loadNibNamed:NSStringFromClass([JSQMessagesViewController class])
                                  owner:self
                                options:nil];
    
    COMMON_LOG_WITH_COMMENT(@"Nib loaded")
    
    [self jsq_configureMessagesViewController];
    
    COMMON_LOG_WITH_COMMENT(@"Configured messages view controller")
    
    [self jsq_registerForNotifications:YES];
    
    COMMON_LOG_WITH_COMMENT(@"Registered for notifications")
}
...
{
    NSLog(@"JSQMessagesViewController -collectionView:cellForItemAtIndexPath:, thread = %@", [NSThread currentThread]);
