...
- (UIImage *)imageToFitSize:(CGSize)fitSize method:(MGImageResizingMethod)resizeMethod
{
    ...
    // Max de Vere comment: I have commented out the below as it was throwing a warning, but it's unnecessary code anyway because we only get to this point with a nil image if iPhone version is < __IPHONE_4_0
